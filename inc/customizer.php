...
add_action( 'customize_register', 'vanilla_customize_register' );
...
function vanilla_customize_preview_js() {
	wp_enqueue_script( 'vanilla-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
