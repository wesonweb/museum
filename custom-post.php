...
/****************************************************************************
 *register custom event post - this is for individual  news items
 ****************************************************************************/
...
/****************************************************************************
 *register custom event post - this is for image slideshows
 ****************************************************************************/
...
function create_photo_tags() {
	...
	$labels = array (
		'name'				=> 'Tags: photos',
		'singular-name' 	=> 'Tags: photo',
		'search_items'		=> 'Search all photo Tags',
		'all_items'			=> 'All photo Tags',
		'parent_item'		=> 'Parent photo Tags',
		'parent_item_colon'	=> 'Parent photo Tags:',
		'update_item'		=> 'Update photo Tags',
		'edit_item'			=> 'Edit photo Tags',
		'add_new_item'		=> 'Add a new photo Tags',
		'new_item_name'		=> 'New  photo Tags',
	...
	$args = array (
		...
		'show_admin_column'	=>	true,
		'query_var'			=>	true,
		'rewrite'			=> 	array ('slug' => 'photo-taglist')
